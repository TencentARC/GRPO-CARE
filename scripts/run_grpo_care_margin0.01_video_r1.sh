...
export VIDEO_R1_DATA_ROOT=[your path to Video-R1 training data]

QWEN_PATH="${PROJECT_ROOT}/ckpt/Qwen2.5-VL-7B-Instruct"
HF_DATASET="${VIDEO_R1_DATA_ROOT}/Video-R1-260k.json"
...
export RUN_NAME="Qwen2.5-VL-7B-GRPO-CARE-Margin0.01-Video-R1"
...
cd ${PROJECT_ROOT}
nohup bash scripts/run_grpo_care_margin0.01_video_r1.sh > scripts/run_grpo_care_margin0.01_video_r1.log 2>&1 &
tail -f scripts/run_grpo_care_margin0.01_video_r1.log
COMMENT